...
if __name__ == '__main__':
    split = splitbase(
                        # basepath=r'dataset/dataset_demo',
                        # outpath=r'dataset/dataset_demo_rate1.0_split1024_gap200',
                        basepath=r'/media/lyt/daaize1T/python_foot/AugPic-tools-master/tools-master/DataAugForObjectSegmentation/picandtxt',
                        outpath=r'/media/lyt/daaize1T/python_foot/AugPic-tools-master/tools-master/DataAugForObjectSegmentation/splitpicandtxt',
                        # basepath=r'/media/lyt/00F68E2CF68E2250/yolov5_obb-master/dataset/dataset_demo',
                        # outpath=r'/media/lyt/00F68E2CF68E2250/yolov5_obb-master/dataset/dataset_demo_rate1.0_split1024_gap200',
                        gap=200,
                        subsize=1024,
                        # num_process=8
                        num_process=4)
