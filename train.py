...
# import wandb
#
# wandb.init(project="yolov5_obb-master", entity="daaize")
            ...
            if f.exists():
                ...
                if f is best:
                    ...
                    results, _, _ = val.run(data_dict,
                                            ...
                                            # iou_thres=0.80 if is_coco else 0.85,
                                            iou_thres=0.25 if is_coco else 0.20,
                                            single_cls=single_cls,
                                            dataloader=val_loader,
                                            save_dir=save_dir,
                                            save_json=is_coco,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5_ShuffleAttGatherExciteGSC231005.yaml', help='model.yaml path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')  # default 默认为False , 如果意外中断想要继续训练，则将default设置为True
...
def main(opt, callbacks=Callbacks()):
    ...
    os.environ["WANDB_API_KEY"] = 'ba7b044bff5bb11512f9f806f125be144fcab148'
